...
return null;        }
    ...
    public List<Book> getRelatedBook(int id) {
        ...
        String sql1 = "select top 1 b.BookID, Title, c.CategoryID\n"
        ...
        try {
            ...
            if (rs1.next()) {
                ...
                String sql2 = "select top 4 b.BookID, Title, PublisherName, Price, Quantity, Image_Link\n"
...
return null;        }
    ...
    public void updateNewBook(Book b, int pId) {
        String sql = "INSERT INTO Books\n"
                + "           ([Title], [PublisherID] ,[Price] ,[Quantity] ,[Image_Link])\n"
                + "     VALUES (?, ?, ?, ?, ?)";
        try {
            PreparedStatement st = connection.prepareStatement(sql);
    ...
    public int updateBoughtBook(Item item) {
        String sql = "UPDATE [dbo].[Books]\n"
                + "   SET [Title] = ?\n"
                + "      ,[PublisherID] = ?\n"
                + "      ,[Price] = ?\n"
        ...
        try {
            ...
            st.setInt(2, pId);
            st.setFloat(3, item.getBook().getPrice());
    ...
    public List<Book> getHotBook() {
        ...
        String sql = "select top 12 b.BookID, Title, PublisherName, Price, b.Quantity, Image_Link\n"
