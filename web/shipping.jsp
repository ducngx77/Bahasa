...
<html>
    <head>
        <title>Bahasa.com | Shipping</title>
    ...
    <body>
        ...
        <div class="banner-top" style="background-color: gray">
            <div class="container">
                <h3 >Shipping</h3>
                <h4><a href="default.jsp">Home</a><label>/</label>Shipping</h4>
                ...
                <div class="panel-group" id="accordion">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h4 class="panel-title" data-toggle="collapse" data-target="#collapseThree">
                                <span>3.</span> Bahasa có hỗ trợ vận chuyển quốc tế không?
                            </h4>
                        </div>
                        <div id="collapseThree" class="panel-collapse collapse">
                            <div class="panel-body">
                                <p>Rất tiếc, hiện tại Bahasa.com cũng như các đối tác giao hàng của Bahasa.com không hỗ trợ giao hàng quốc tế.</p>
                            </div>
                        </div>
                    </div>
                    <!-- Fourth Panel -->
                    <div class="panel panel-default">
                        ...
                        <div id="collapseFour" class="panel-collapse collapse">
                            <div class="panel-body">
                                <p>Đơn hàng kể từ lúc đặt hàng sẽ mất khoảng từ 1 đến 4 ngày để có thể giao đến tận nơi cho khách hàng. Nếu quá thời hạn trên mà quý khách vẫn chưa nhận được hàng, vui lòng liên hệ số: +1234 758 839 để được hỗ trợ.</p>
                            </div>
                        </div>
                    </div>                   
                </div>
