        ...
        <div class="container">
            ...
            <div class="col-md-3 footer-grid ">
                ...
                <ul>
                    ...
                    <li><a href="<%=request.getContextPath()%>">Sách trong nước</a></li>
                    <li><a href="<%=request.getContextPath()%>">Sách nước ngoài</a></li>
                    <li><a href="<%=request.getContextPath()%>">Văn phòng phẩm</a></li>						 
